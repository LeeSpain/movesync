...
const InvestmentCTA = () => {
  ...
  return (
    <Card className="p-8 rounded-xl shadow-lg border-0 bg-gradient-to-br from-blue-600 to-indigo-700 text-white">
      <div className="max-w-3xl mx-auto text-center">
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-8">
          <div className="bg-white/10 p-5 rounded-xl backdrop-blur-sm">
            <Users className="h-10 w-10 mx-auto mb-4 text-blue-200" />
          ...
          <div className="bg-white/10 p-5 rounded-xl backdrop-blur-sm">
            <DollarSign className="h-10 w-10 mx-auto mb-4 text-blue-200" />
          ...
          <div className="bg-white/10 p-5 rounded-xl backdrop-blur-sm">
            <Mail className="h-10 w-10 mx-auto mb-4 text-blue-200" />
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
          <Button
            asChild
            size="lg"
            className="bg-white text-blue-700 hover:bg-blue-50 border-none shadow-lg min-w-40 text-base"
          >
            <Link to="/contact">
